...
This directory is the source of truth for `@agentmeshkit/chatbox`.

## Component scope

- Responsibility: Reusable React chat composer, attachment handling, and file/folder upload behavior.
- Registry: GitHub Packages.
- Current consumer: AgentWeb frontend.
